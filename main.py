...
- You may:
    ...
    - adapt/rephrase them for contextual correctness,  
    - ignore them entirely if they do not fit meaning.
- If a glossary equivalent is not appropriate in context, choose the correct formulation instead.
...
def translate(req: TranslateRequest, x_access_key: str = Header(default="")) -> TranslateResponse:
    ...
    # Same language: return as-is; draft == translation
    ...
    try:
        ...
        # ✅ Always return translation + draft + terms
